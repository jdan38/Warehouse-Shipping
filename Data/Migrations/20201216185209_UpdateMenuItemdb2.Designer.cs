...
namespace Warehouse.Data.Migrations
{
    ...
    [Migration("20201216185209_UpdateMenuItemdb2")]
    partial class UpdateMenuItemdb2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Warehouse.Models.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Warehouse.Models.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Warehouse.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Warehouse.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Warehouse.Models.SubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Warehouse.Models.MenuItem", b =>
                {
                    ...
                    b.HasOne("Warehouse.Models.SubCategory", "SubCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Warehouse.Models.OrderDetails", b =>
                {
                    b.HasOne("Warehouse.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Warehouse.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("Warehouse.Models.OrderHeader", b =>
                {
                    b.HasOne("Warehouse.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
